public class Json.Api.Error : Json.Api.Object
{
	...
	public Error (string id, ErrorLinks links, string status, string title, string details, ErrorSource source)
	{
		GLib.Object (id: id, links: links, status: status, title: title, details: details, source: source);
	}
}
